...
func NewProduct(rootDir string, db *model.DB) (*Product, error) {
...
func (e *Product) searchFile(file string) string {
...
func (e *Product) staticHandler(w http.ResponseWriter, r *http.Request) {
	log := func(err error) {
...
func (e *Product) setupRouter(products []*model.Product, productPagesHtml []string) {
...
func (e *Product) readProducts(r io.Reader) ([]*model.Product, error) {
...
func (e *Product) notFound(w http.ResponseWriter, r *http.Request) {
...
func (e *Product) handleSpecifiedFile(filename string, w http.ResponseWriter, r *http.Request) {
...
func (e *Product) ServeHTTP(w http.ResponseWriter, r *http.Request) {
